...
% DOCUMENT
% ======================================================================
\title[Architecture Logicielles : Microservices]{\textbf{Architectures logicielles : services, microservices et BPM}}
\subtitle{Étude Comparative d'Architectures API : SOAP, REST, GraphQL et gRPC}
\author{Aya Morsli \and Mohamed Chtouqui}
\institute{VAP DSI \\[0.5cm] \textit{Encadré par :} Pr Walid Gaaloul}
\date{27/02/2026}
